  ...
  'zh-CN': [
    ...
    },
    {
      ...
      sections: [
        ...
        { title: '四、上线信息公示', paragraphs: ['本 Alpha 版本仅供获授权院校测试和部署。正式面向公众或大规模上线前，运营主体名称、注册地址、有效联系方式、个人信息保护联络方式、投诉举报渠道、数据存储安排及院校角色分工应在上线页面和院校公告中补充为真实、可联系的信息。本规则不替代适用法律、院校制度或专业法律意见。'] },
      ],
    },
  ],
  'en-US': [
    ...
    },
    {
      ...
      sections: [
        ...
        { title: '4. Launch disclosures', paragraphs: ['This Alpha version is for authorized institution testing and deployment. Before public or large-scale launch, the operator name, registered address, effective contact details, personal-information contact, complaint route, storage arrangement, and institution role allocation must be published as real contactable information in the launch page and institution notice. This rule does not replace applicable law, institutional policy, or professional legal advice.'] },
      ],
    },
  ],
}
